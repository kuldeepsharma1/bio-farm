...
export default function Sustainability() {
  ...
  return (
    <main className="overflow-hidden">
      {/* Hero Section */}
      <section className="relative min-h-[90vh] flex items-center bg-linear-to-br from-green-900 via-emerald-900 to-green-800">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-linear-to-b from-green-950/80 via-green-900/80 to-emerald-900/90"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="block bg-linear-to-r from-green-400 to-emerald-400 text-transparent bg-clip-text">
                Sustainable Future
              </span>
            </motion.h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            >
              ...
              <span className="block bg-linear-to-r from-green-600 to-emerald-600 text-transparent bg-clip-text">
                Make a Difference
              </span>
            </motion.h2>
          ...
          >
            {initiatives.map((initiative) => (
              ...
              >
                <div className={`absolute inset-x-0 -top-px h-1 rounded-t-2xl bg-linear-to-r ${initiative.color}`}></div>
                <div className="relative">
                  <div className={`inline-flex items-center justify-center w-16 h-16 mb-6 rounded-xl 
                                text-white bg-linear-to-br ${initiative.color} group-hover:scale-110 
          ...
          >
            <motion.div variants={fadeInUp}>
              ...
              <div className="space-y-8">
                {processes.map((process) => (
                  ...
                  >
                    <span className="text-5xl font-bold bg-linear-to-br from-green-200 to-green-300 
            ...
            >
              <div className="relative h-150 rounded-2xl overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-linear-to-t from-green-950/50 to-transparent"></div>
              </div>
              {/* Decorative Elements */}
      ...
      {/* CTA Section */}
      <section className="py-24 bg-linear-to-br from-green-900 via-emerald-900 to-green-800 relative overflow-hidden">

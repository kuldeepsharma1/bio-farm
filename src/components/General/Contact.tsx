    ...
    <main className="min-h-screen bg-gray-50 flex items-center justify-center p-4 sm:p-6 lg:p-8">
      ...
      >
        <motion.div variants={itemVariants}>
          <div className="w-20 h-20 mx-auto mb-8 rounded-full bg-linear-to-br from-emerald-600 to-green-600 flex items-center justify-center text-white shadow-lg shadow-emerald-500/25">
        ...
        <motion.a
          ...
          className="inline-flex items-center px-10 py-4 rounded-full bg-linear-to-r from-emerald-600 to-green-600 text-white font-semibold text-xl

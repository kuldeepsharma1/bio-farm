...
import { ArrowRight, CircleQuestionMark, Mail } from "lucide-react";
...
export default function SupportPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-b from-gray-50 to-white text-gray-900 flex flex-col items-center overflow-x-hidden">
      ...
      <section className="w-full py-20 md:py-28 text-center relative overflow-hidden">
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            >
              Contact Support <ArrowRight className="ml-3 text-white/90" />
            </a>
          </motion.div>
        </motion.div>
      </section>
            ...
            <motion.div variants={itemVariants}>
              ...
              >
                <div className="p-4 bg-green-50 rounded-full group-hover:bg-green-100 transition-colors">
                  <CircleQuestionMark className="text-green-600 text-3xl group-hover:text-green-700 transition-colors" />
                </div>
                <div>
                ...
                <ArrowRight className="text-green-500 group-hover:text-green-700 transition-transform group-hover:translate-x-1" />
              </Link>
            </motion.div>
            {/* Shipping Info */}
            <motion.div variants={itemVariants}>
      ...
      <section id="email-contact" className="w-full bg-white py-16 md:py-24 px-6 md:px-16 lg:px-24 border-t border-gray-100">
        ...
        >
          ...
          <motion.a
            ...
            className="inline-flex items-center px-10 py-5 rounded-full bg-linear-to-r from-green-600 to-emerald-600 text-white font-semibold text-xl
                       shadow-xl shadow-green-500/30 hover:shadow-2xl hover:shadow-green-500/40
                       transform hover:-translate-y-1 transition-all duration-300 ease-in-out
                       focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
          >
            <Mail className="mr-4 text-white text-2xl" />

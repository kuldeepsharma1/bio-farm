    ...
    <>
      {user?.email ? (
        <div className="relative">
          ...
          >
            {user.image ? (
              ...
              <div className="w-8 h-8 bg-linear-to-br from-green-500 to-teal-600 rounded-full flex items-center justify-center text-white font-semibold text-sm shadow-md">
        ...
        <div className="hidden lg:flex items-center gap-2">
          ...
          <Link
            href="/sign-up"
            className="px-4 py-2 text-sm font-medium text-white bg-linear-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500/20"
          >
            Get Started
          </Link>
        </div>

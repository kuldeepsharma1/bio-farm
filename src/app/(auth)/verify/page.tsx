...
export default function VerifyEmail() {
  return (
    <div className="min-h-screen flex bg-white">
      {/* Left Column - Professional Design (Unchanged) */}
      <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
        {/* Multi-layered background for depth */}
        <div className="absolute inset-0">
          {/* Base gradient */}
          <div className="absolute inset-0 bg-linear-to-br from-green-800 via-green-600 to-green-400" />
        ...
        <div className="relative h-full flex flex-col p-16 z-10">
          ...
          <div className="flex items-center space-x-4 mb-16">
            <div className="w-14 h-14 bg-white/10 backdrop-blur-xl rounded-2xl 
              ...
              <div className="absolute inset-0 bg-linear-to-br from-white/20 to-transparent opacity-0 
          ...
          <div className="max-w-lg">
            ...
            <p className="text-xl text-white/80 leading-relaxed">
              ...
              and gives you access to all Arkin features.
            </p>
          </div>
      ...
      {/* Right Column - Premium White Experience */}
      <div className="flex-1 flex items-center justify-center bg-white p-8 lg:p-12 relative">
        {/* Subtle premium background pattern */}
        <div className="absolute inset-0 bg-[radial-gradient(#f1f5f9_0.8px,transparent_1px)] bg-size-[4px_4px] opacity-60" />
        
        <div className="relative w-full max-w-md">
          {/* Elegant top accent bar */}
          <div className="flex justify-center mb-8">
            <div className="w-16 h-1 bg-linear-to-r from-green-500 to-emerald-400 rounded-full" />
          </div>

          {/* Premium Card Container */}
          <div className="bg-white rounded-3xl shadow-xl shadow-gray-200/60 border border-gray-100 p-10 relative overflow-hidden">
            {/* Subtle corner accent */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-linear-to-br from-green-50 to-transparent rounded-bl-[100px]" />
            ...
            <Suspense fallback={
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <h2 className="text-2xl font-semibold text-gray-900 tracking-tight">Verifying your email</h2>
          ...
          <div className="flex justify-center mt-6">
            <div className="flex items-center gap-2 text-xs text-gray-400">
              ...
              <span>Secure verification powered by Arkin</span>
            </div>
          </div>
        </div>
      </div>
